...
#include "src/BranchChecker_rb2.h"
...
int main(int argc, char *argv[]) {
    ...
    int input6_1[TEST_SIZE][11] = {
        {4, 10, 13, 19, 24, 31, 54, 20, 25, 32, 55},
        {3, 8, 11, 5, 7, 9, 29, 6, 8, 10, 30},
        {7, 6, 5, -4, -3, -2, -1, 4, 3, 2, 1},
        {20, 200, 4, 1, 2, 24, 5, 2, 3, 25, 5},
        {7, 6, 5, -4, -3, -2, -1, 4, 3, 2, 1},
        {20, 200, 5, 1, 2, 24, 4, 2, 3, 25, 5},
//        {8, -24, -29, 60, -18, 20, 24, -13, -10, -26, 15 },
        {38, 6, 1, 90, 12, 50, 54, 17, 20, 4, 45 }
//        {24, -8, -13, 76, -2, 36, 40, 3, 6, -10, 31 }
    };
...
//
//            for (int i = 0; i < 11; i++) {
//                node = rbtree_insert(tree, input6_1[test_index][i]);
//            }
//
//            // int* actual_output7 = rb_get_inorder(tree->root);
//
//            // for (int i = 0; i < 11; i++) {
//            //    printf("%d, ", actual_output7[i]);
//            // }
...
//
//            for (int i = 0; i < 3; i++) {
//                Node_RB* targetNode = rbtree_find(tree, input6_2[test_index][i]);
//                printf("Target: %d\n", targetNode->data);
//                if(targetNode != NULL) {
//                    tree->root = rbtree_delete(tree, targetNode);
//                }
//            }
//
//            int* actual_output7 = rb_get_inorder(tree->root);
